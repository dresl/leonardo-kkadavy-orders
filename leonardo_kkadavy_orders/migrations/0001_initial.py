    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telefon', models.PositiveIntegerField(default=b'', verbose_name=b'Telefon')),
                ('adresa', models.CharField(default=b'', max_length=255, verbose_name=b'Doru\xc4\x8dovac\xc3\xad adresa')),
                ('firma', models.CharField(default=b'', help_text=b'Nepovinn\xc3\xa9 pole', max_length=255, verbose_name=b'N\xc3\xa1zev firmy', blank=True)),
                ('ico', models.CharField(default=b'', help_text=b'Nepovinn\xc3\xa9 pole', max_length=255, verbose_name=b'I\xc4\x8cO', blank=True)),
                ('dic', models.CharField(default=b'', help_text=b'Nepovinn\xc3\xa9 pole', max_length=255, verbose_name=b'DI\xc4\x8c', blank=True)),
                ('pub_date', models.DateTimeField(auto_now_add=True, verbose_name=b'Datum Objednavky')),
            ],
            options={
                'ordering': ['prijmeni'],
